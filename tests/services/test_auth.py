...
class TestLogin:
    async def test_success(self, mock_get_session, user_repo, jwt_provider, password_provider, make_user):
        user = make_user()
    ...
    async def test_user_not_found(self, mock_get_session, user_repo, jwt_provider, password_provider):
    ...
    async def test_wrong_password(self, mock_get_session, user_repo, jwt_provider, password_provider, make_user):
        user = make_user()
        user_repo.get_by_email.return_value = user
...
class TestGetCurrentUser:
    async def test_valid_token(self, mock_get_session, user_repo, jwt_provider, password_provider, make_user):
        user = make_user()
    ...
    async def test_expired_token(self, mock_get_session, user_repo, jwt_provider, password_provider):
    ...
    async def test_malformed_token(self, mock_get_session, user_repo, jwt_provider, password_provider):
    ...
    async def test_user_deleted(self, mock_get_session, user_repo, jwt_provider, password_provider):
